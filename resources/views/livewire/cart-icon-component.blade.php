        ...
        <ul>
            ...
            <li>
                <div class="shopping-cart-img">
                    <a href="{{ route('product.detail',['slug']=> $item->model->slug) }}"><img alt="{{ $item->model->name }}"
                            src="{{ asset('assets/imgs/shop/product-') }}{{ $item->model->id }}-1.jpg"></a>
                </div>
                <div class="shopping-cart-title">
                    <h4><a href="{{ route('product.detail',['slug']=> $item->model->slug) }}">{{ Str::substr($item->model->name,0,20) }}...</a></h4>
