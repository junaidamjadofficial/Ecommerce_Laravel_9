                                                ...
                                                <div class="product-img product-img-zoom">
                                                    <a href="{{ route('product.detail',['slug'=>$rproduct->slug]) }}" tabindex="0">
                                                        <img class="default-img"
                                                            src="{{asset('assets/imgs/shop/product-')}}{{ $rproduct->id }}-1.jpg" alt="{{ $rproduct->name }}">
                                                        <img class="hover-img" src="{{asset('assets/imgs/shop/product-')}}{{ $rproduct->id }}-2.jpg"
                                                            alt="">
                                                    </a>
                                                </div>
                    ...
                    <div class="sidebar-widget product-sidebar  mb-30 p-30 bg-grey border-radius-10">
                        ...
                        <div class="single-post clearfix">
                            ...
                            <div class="content pt-10">
                                <h5><a href="{{ route('product.detail',['slug'=>$nproduct->slug]) }}">{{ $nproduct->name }}</a></h5>
